...
class TestDelishScraper(ScraperTest):
    ...
    def test_yields(self):
        self.assertEqual(self.harvester_class.yields(), "8-10 servings")

    def test_image(self):
        self.assertEqual(
            self.harvester_class.image(),
            "https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/delish-190814-pumpkin-roll-0046-landscape-pf-1567187755.jpg",
        )
