...
class TestSteamyKitchenScraper(ScraperTest):
    ...
    def test_title(self):
        self.assertEqual(self.harvester_class.title(), "Instant Pot Vietnamese Chicken Pho")

    def test_description(self):
        self.assertEqual(self.harvester_class.description(), "This Vietnamese Chicken Pho is the definition of a cozy and comforting meal. In less than 1 hour you will have a nourishing bowl of warm noodle soup!")
