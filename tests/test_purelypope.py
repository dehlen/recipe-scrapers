...
class TestPurelyPopeScraper(ScraperTest):
    ...
    def test_instructions(self):
        return self.assertEqual(
            "Instructions Brussel Sprout Time! Preheat oven to 350 degrees. Whisk the sauce (coconut aminos, sriracha, maple syrup & sesame oil) together in a large bowl. Toss in brussel sprouts and coat mixture evenly over the brussels. Roast for 30 minutes. Turn oven to broil for 2-3 minutes to crisp (watch carefully to not burn.) Top with everything or sesame seeds.",
